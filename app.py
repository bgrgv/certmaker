...
font=ImageFont.truetype("files/impact.ttf",81)
authimage=Image.new('RGB', (600,600),color='black')
authimage.save('author.jpg')
authimage=Image.open('author.jpg')
putText=ImageDraw.Draw(authimage)
font=ImageFont.truetype("files/tahoma.ttf",30)
w,h = putText.textsize(text, font=font)
putText.text(((W-w-450)/2,(H-h-200)/2), 'CERTFICATE GEN v1 \n\n\nBY BLESSIN', fill="WHITE",font=font)
authimage.save('author.png','PNG')
os.remove('author.jpg')